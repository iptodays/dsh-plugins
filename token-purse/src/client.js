...
const zh = {
  ...
  "daily.empty": "还没有历史记录",
  "peak.splitHint": "本会话按当时生效的费率档位汇总（加价制为高峰 / 低峰，折扣制为优惠 / 标准价，另有平价）",
  "peak.deal": "优惠 ×{factor}",
  "peak.standard": "标准价",
...
const en = {
  ...
  "peak.splitHint": "This session grouped by the rate bracket that applied (peak / off-peak under a surcharge scheme, discount / standard under a discount one, plus flat)",
